...
public class Solution {
    ...
    private BlockingQueue<String> messageQueue = new LinkedBlockingQueue<String>(); // Тут будут храниться все сообщения

    private BlockingQueue<Object> fakeDatabase = new LinkedBlockingQueue<>();
    ...
    public void startPersistingMessages() {
        for (int i = 0; i < NUMBER_OF_THREADS; i++) {
            new Thread() {
                private final List batch = new ArrayList(MAX_BATCH_SIZE);
